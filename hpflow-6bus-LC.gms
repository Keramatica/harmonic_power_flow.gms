...
co17(k,i,ti)$(ord(k)<> 1)     ..(vmg(k,i,ti)$(ord(k)<> 1))/(vmg('1',i,ti)+0.0000000001) =l=0.025;
**************************************************************************************
...
display y_h,branch,pgg.l,qgg.l,v.l,vrms.l,snl,ilr.l,ilim.l,thdv,inlr.l,inlim.l,iim.l,ir.l;
  ...
  execute_unload "results_6hpf_z.gdx" VRMS
    execute 'gdxxrw.exe results_6hpf_z.gdx Var=VRMS rng=classic1!'
   execute_unload "results_6hpf_z.gdx" P
   execute 'gdxxrw.exe results_6hpf_z.gdx Var=P rng=classic2!'
   execute_unload "results_6hpf_z.gdx" Q
   execute 'gdxxrw.exe results_6hpf_z.gdx Var=Q rng=classic3!'
   execute_unload "results_6hpf_z.gdx" THDv
   execute 'gdxxrw.exe results_6hpf_z.gdx par=THDv rng=classic4!'
